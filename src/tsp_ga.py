...
def run_ga(genes, pop_size, n_gen, tourn_size, mut_rate, verbose=1):
    ...
    if verbose:
        print("TSP-GA: Inicializando evolución")
    ...
    if verbose:
        print("TSP-GA:  Evolucion finalizada despues de  {} generaciones en {} s".format(generations, total_time))
        print("TSP-GA:  Costo minimo de viaje {} kilometros".format(min_cost))
